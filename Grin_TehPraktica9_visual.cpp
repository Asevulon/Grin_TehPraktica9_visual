...
// Grin_TehPraktica9_visual.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGrinTehPraktica9visualApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGrinTehPraktica9visualApp

CGrinTehPraktica9visualApp::CGrinTehPraktica9visualApp()
{
...
// Единственный объект CGrinTehPraktica9visualApp

CGrinTehPraktica9visualApp theApp;


// Инициализация CGrinTehPraktica9visualApp

BOOL CGrinTehPraktica9visualApp::InitInstance()
{
